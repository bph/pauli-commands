...
if (undefined !== wp.editPost) {
  ...
  (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.dispatch)(_wordpress_commands__WEBPACK_IMPORTED_MODULE_0__.store).registerCommand({
    ...
    callback: ({
      ...
      (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.dispatch)('core/edit-post').toggleEditorPanelEnabled('discussion-panel');
      close();
    }
  });
}
(0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.dispatch)(_wordpress_commands__WEBPACK_IMPORTED_MODULE_0__.store).registerCommand({
  ...
  callback: ({
    ...
    if (undefined !== wp.editSite) {
      (0,_wordpress_data__WEBPACK_IMPORTED_MODULE_1__.dispatch)('core/preferences').toggle('core/edit-site', 'showIconLabels');
    }
